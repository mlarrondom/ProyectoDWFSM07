  ...
  const openReqModal = async (cert) => {
    ...
    try {
      ...
      const res = await fetch(
        `${API}/api/certifications/${cert.certCode}/requirements`
      );
      const data = await res.json();
              ...
              {reqLoading ? (
                ...
                <>
                  ...
                  <div className="mb-3" style={{ fontWeight: 700 }}>
                    Para obtener esta certificación, debes completar los siguientes
                    requisitos:
                  </div>
                  ...
                  {reqViewModel.creditsNeeded != null && (
                    <div className="ds-card mb-3" style={{ padding: 14 }}>
                      <div className="d-flex align-items-start gap-2">
                        ...
                        <div>
                          <div style={{ fontWeight: 800 }}>Requisito 1</div>
                  ...
                  {reqViewModel.requirementsChecklist.length === 0 ? (
                    <div className="alert alert-secondary">
                      Esta certificación no tiene requerimientos de asignaturas.
                    </div>
                  ) : (
