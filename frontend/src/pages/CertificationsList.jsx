...
import CertificationsDetail from './CertificationsDetail'; 
        ...
        <div className="container py-2 ds-table-page">
            ...
            {openCreate && (
                <div onClick={closeCreateModal} className="ds-modal-backdrop">
                    <div onClick={(e) => e.stopPropagation()} className="ds-modal ds-modal-xxl">
            ...
            {selectedCertCode && (
                <div onClick={closeViewModal} className="ds-modal-backdrop">
                    <div onClick={(e) => e.stopPropagation()} className="ds-modal ds-modal-xxl">
                        <div className="ds-modal-header">
                            <h5 className="ds-modal-title m-0">Certificación {selectedCertCode}</h5>
