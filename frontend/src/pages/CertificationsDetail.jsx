...
export default function CertificationsDetail({ certCode, onUpdated }) {
    ...
    const fetchCertification = async () => {
        ...
        try {
            ...
            setGeneralForm({
                ...
                price: c?.price === 0 || c?.price ? String(c.price) : '0', // ✅ nuevo
            });
        } catch (err) {
    ...
    const conditionLabel = (cond) => CONDITION_OPTIONS.find((c) => c.value === cond)?.label || cond;
    ...
    const saveGeneral = async () => {
        ...
        const priceNum =
            generalForm.price === '' ||
            generalForm.price === null ||
            generalForm.price === undefined
                ? 0
                                            ...
                                            {!isEditingRow ? (
                                                <div className="d-inline-flex gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() =>
                                                            handleDeleteRequirement(r.requirementId)
                                                        }
                                                ...
                                                <div className="d-inline-flex gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="btn btn-link btn-ghost btn-icon d-inline-flex align-items-center justify-content-center"
                                                        onClick={() =>
                                                            saveEditRequirement(r.requirementId)
                                                        }
                                                        title="Guardar"
                                                        disabled={savingEditReq}
                                                    >
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => {
                                                ...
                                                setReqForm((p) => ({
                                                    ...
                                                    condition:
                                                        nextType === 'CREDITS' ? 'Y' : p.condition,
                                                    creditsRequired: '',
                                                    courseInput: '',
                                                }));
                                            }}
                                            ...
                                            <>
                                                ...
                                                {courses.length === 0 && !loadingCourses && (
                                                    <div
                                                        ...
                                                        style={{ fontSize: 12 }}
                                                    >
                                                        No se pudieron cargar cursos (o tu rol no
                                                        tiene acceso). Puedes escribir el código
                                                        exacto igualmente.
                                                    </div>
                                                )}
                                            </>
