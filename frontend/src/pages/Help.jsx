                            ...
                            <div className="row align-items-center g-5">
                                ...
                                <div className="col-12 col-lg-7">
                                    ...
                                    <p className="help-lead mb-4">
                                        ...
                                        Aquí respondemos lo más importante para que tomes
                            ...
                            <div className="row g-4">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        a: "Para revisar el catálogo no, pues es público, pero sí para comprar certificaciones.",
                                    },
                                ].map((item, idx) => (
                                    <div className="col-12 col-lg-6" key={idx}>
                                        <div className="help-faq-card p-4 h-100">
                                            <h5>{item.q}</h5>
